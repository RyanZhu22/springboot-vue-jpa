...
<template>
  <!-- Btn Section -->
    <div style="padding: 10px 0">
        <el-input style="width: 200px" placeholder="Please input username" suffix-icon="el-icon-search"
                  v-model="username"/>
        <el-input style="width: 200px" placeholder="Please input email" suffix-icon="el-icon-message" class="ml-5"
                  v-model="email"/>
        <el-input style="width: 200px" placeholder="Please input address" suffix-icon="el-icon-position"
                  v-model="address"
                  class="ml-5"/>
    ...
    <div style="padding: 10px">
        ...
        <el-upload action="http://localhost:8001/api/user/import" :show-files-list="false" accept=".xlsx"
        ...
        <el-form label-width="100px" :model="addForm" style="max-width: 460px">
            ...
            <el-form-item label="Role">
                <el-select v-model="addForm.role">
                    <el-option v-for="item in roles" :label="item.name" :key="item.id"></el-option>
                </el-select>
            </el-form-item>
